...
<main class="max-w-6xl mx-auto p-6 lg:py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="space-y-3">
                <button class="w-full bg-amber-600 text-white font-bold py-3 rounded-xl hover:bg-amber-700 transition">
                    Pinjam Buku
                </button>
                <div class="flex gap-2">
                    <a href="{{ route('MDU') }}" class="flex-1 flex justify-center items-center gap-2 border border-gray-200 py-2 rounded-lg text-sm font-medium hover:bg-gray-50">
                        <span>⬅️</span> Kembali
                    </a>
        ...
        <div class="lg:col-span-8">
            <div class="mb-8">
                <span class="text-amber-600 text-xs font-bold px-3 py-1 bg-amber-50 rounded-full uppercase">
                    Kategori: {{$pinjam->RelasiKategori->nama_kategori ?? 'Tanpa Kategori'}}
                </span>
            ...
            <div id="box-data" class="hidden">
                <ul class="space-y-2 text-sm">
                    <li class="flex justify-between p-2 border-b"><span>Penerbit</span> <b>{{$pinjam->penerbit}}</b></li>
                    <li class="flex justify-between p-2 border-b"><span>ISBN</span> <b>{{$pinjam->isbn}}</b></li>
                    <li class="flex justify-between p-2 border-b"><span>Tahun Terbit</span> <b>{{$pinjam->tahun_terbit}}</b></li>
                </ul>
            </div>
        </div>
    </div>
