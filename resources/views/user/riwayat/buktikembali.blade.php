...
<head>
    ...
    <title>Cetak Bukti Pengembalian - Aksara</title>
        ...
        <div class="bg-white shadow-2xl overflow-hidden print-card border border-slate-200 rounded-2xl">
            ...
            <div class="bg-slate-900 p-6 text-white flex justify-between items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-[9px] text-slate-400 font-bold tracking-[0.2em] mt-1 uppercase">BUKTI PENGEMBALIAN BUKU SELESAI</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-amber-500 font-bold tracking-[0.2em] text-[8px] uppercase">ID Transaksi</p>
                    <p class="text-sm font-mono font-bold">
                        #RET-{{ $peminjaman->updated_at->format('Ymd') }}-{{ $peminjaman->id }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 border-b border-slate-100">
                <div class="p-5 border-r border-slate-100">
                    <span
                        class="text-slate-400 text-[8px] font-extrabold uppercase tracking-widest block mb-1">Peminjam</span>
                ...
                <div class="p-5 border-r border-slate-100 bg-slate-50/30">
                    <span class="text-slate-400 text-[8px] font-extrabold uppercase tracking-widest block mb-1">Tgl Pinjam</span>
                ...
                <div class="p-5 bg-amber-50/50">
                    <span class="text-emerald-600 text-[8px] font-extrabold uppercase tracking-widest block mb-1 uppercase">Berhasil Kembali</span>
                    <p class="text-emerald-700 font-black text-sm underline decoration-2 underline-offset-4 uppercase italic">
            ...
            <div class="p-8">
                <div class="flex items-start gap-8">
                    ...
                    <div class="flex-1">
                        <span
                            class="bg-emerald-600 text-white px-2 py-0.5 rounded text-[8px] font-black tracking-widest uppercase italic">Sudah Dikembalikan</span>
                        <h4
                        ...
                        <div class="grid grid-cols-2 gap-x-8 gap-y-3 border-t border-slate-50 pt-4">
                            <div>
                                ...
                                <p class="text-slate-700 font-bold text-xs uppercase">{{ $peminjaman->buku->penulis }}</p>
                            </div>
                            <div>
                                <p class="text-slate-400 text-[8px] font-bold uppercase tracking-widest">Durasi Pinjam</p>
                                <p class="text-slate-700 font-bold text-xs uppercase">
    {{ floor(\Carbon\Carbon::parse($peminjaman->tanggal_peminjaman)->diffInDays($peminjaman->updated_at)) }} Hari
</p>
                            </div>
                            <div>
                                <p class="text-slate-400 text-[8px] font-bold uppercase tracking-widest">Status Akhir</p>
                                <p class="text-emerald-600 font-bold text-[11px] uppercase italic">Selesai/Diterima</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-8 bg-slate-50 border-t border-slate-100 flex justify-between items-end">
                <div class="space-y-3">
                    <p class="text-slate-800 font-black uppercase text-[9px] tracking-widest flex items-center gap-2">
                        <i class="fas fa-check-circle text-emerald-500 text-xs"></i> Verifikasi Pengembalian:
                    </p>
                    <ul class="text-slate-500 text-[10px] leading-relaxed list-none space-y-1 font-medium italic">
                        <li>- Buku telah diverifikasi kembali ke rak perpustakaan Aksara.</li>
                        <li>- Dokumen ini adalah bukti sah penyelesaian masa pinjam.</li>
                        <li>- Terima kasih telah berkontribusi menjaga kelestarian buku.</li>
                    </ul>
                </div>
                {{-- <div class="text-right no-print">
                    <div class="inline-block p-2 bg-white border border-slate-200 rounded-lg shadow-sm">
        ...
        <p class="text-center text-slate-400 text-[9px] mt-6 font-bold uppercase tracking-widest no-print">
            Divalidasi secara digital pada: {{ now()->format('d/m/Y H:i') }}
        </p>
    </main>
