...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Lora:ital@0;1&display=swap"
        rel="stylesheet">
...
<body class="h-full antialiased text-DarkChocolate">
    ...
    <div class="h-screen w-full flex items-center justify-center p-4 md:p-8 bg-beige main-container">
        ...
        <div
            class="max-w-5xl w-full h-[600px] grid lg:grid-cols-2 bg-white rounded-[32px] overflow-hidden shadow-2xl shadow-Chocolate/5 border border-Caramel/20 relative">

            <a href="javascript:history.back()"
                class="absolute top-6 left-6 z-20 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-MediumBrown/40 hover:text-Chocolate transition-all group">
            ...
            <div class="p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
                <div class="mb-8 text-center lg:text-left">
                    <img src="{{ asset('image/logo.png') }}" alt="Logo"
                        class="h-10 w-auto mb-6 mx-auto lg:mx-0 opacity-90">
                    <h2 class="text-2xl font-serif text-Chocolate mb-1">Selamat Datang</h2>
                    <p class="text-MediumBrown/60 text-xs tracking-tight">Masuk untuk melanjutkan ke perpustakaan
                        digital.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        <label
                            class="text-[10px] font-bold uppercase tracking-wider text-MediumBrown/70 ml-1">Email</label>
                    ...
                    <div class="space-y-1.5">
                        <label
                            class="text-[10px] font-bold uppercase tracking-wider text-MediumBrown/70 ml-1">Password</label>
                        <div class="relative">
                            <input id="password" name="password" type="password" required
                                class="w-full px-5 py-3 bg-beige/20 border border-Caramel/10 rounded-2xl focus:ring-4 focus:ring-Chocolate/5 focus:border-Chocolate transition-all duration-300 text-sm placeholder-MediumBrown/30"
                                placeholder="••••••••">
                            <button type="button" onclick="togglePassword()"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-MediumBrown/40 hover:text-Chocolate transition-colors">
                                <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    @if ($errors->any())
        <div class="mb-5 p-4 rounded-2xl bg-orange-50 border border-orange-100 flex items-start gap-3"">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500 mt-0.5" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    @endif
                ...
                <div class="mt-10 pt-6 border-t border-beige/60">
                    <p class="text-center text-xs text-MediumBrown/60">
                        Belum bergabung?
                        <a href="{{ route('register') }}" class="text-Chocolate font-bold hover:underline ml-1">Daftar
                            sekarang</a>
                    </p>
                </div>
            </div>
            ...
            <div class="hidden lg:block relative bg-beige/30 p-8">
                <div class="h-full w-full rounded-[24px] overflow-hidden relative shadow-inner">
                    <img class="absolute inset-0 h-full w-full object-cover grayscale-[10%]"
                        ...
                        alt="Library">
                    <div class="absolute inset-0 bg-gradient-to-t from-Chocolate/90 via-Chocolate/20 to-transparent">
                    </div>
