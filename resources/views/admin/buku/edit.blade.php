                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="judul_buku" id="judul_buku"
                                            ...
                                            placeholder="Masukkan judul buku" value="{{ old('judul_buku', $book->judul_buku) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="isbn" id="isbn"
                                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all text-sm"
                                            placeholder="978-xxx-xxx-xxx-x" value="{{ old('isbn', $book->isbn) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="tahun_terbit" id="tahun_terbit"
                                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all text-sm"
                                            placeholder="2024" min="1900" max="2100" value="{{ old('tahun_terbit', $book->tahun_terbit) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="stok" id="stok"
                                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all text-sm"
                                            placeholder="0" min="0" value="{{ old('stok', $book->stok) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="image" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition duration-200">
                                    ...
                                    <div id="preview" class="mt-4 hidden">
                                        <img id="preview-image" class="w-32 h-40 object-cover rounded-lg shadow-md" src="{{ asset('storage/' . $book->cover_image) }}" alt="Preview">
                                    </div>
                                </div>
