                    ...
                    <form action="{{ route('update-MDB', $book->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                            ...
                            <div class="lg:col-span-1">
                                <label class="block text-sm font-semibold text-DarkChocolate mb-4">Cover Buku Saat
                                    Ini</label>

                                <div class="relative group">
                                    <div id="preview"
                                        class="mb-4 overflow-hidden rounded-2xl shadow-lg border-4 border-white ring-1 ring-gray-200 aspect-[3/4] bg-gray-50">
                                    ...
                                    <label for="image"
                                        class="flex flex-col items-center justify-center w-full p-4 border-2 border-dashed border-Caramel/40 rounded-xl cursor-pointer bg-beige/5 hover:bg-beige/20 hover:border-Chocolate transition-all group">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div class="md:col-span-2">
                                        <label for="judul_buku"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">Judul Lengkap <span
                                    ...
                                    <div>
                                        <label for="isbn"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">ISBN <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="penulis"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">Nama Penulis <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="penerbit"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">Penerbit <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="tahun_terbit"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">Tahun Terbit <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="stok"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">Jumlah Stok <span
                                                class="text-red-500">*</span></label>
                                        <div class="relative">
                                            ...
                                            <span
                                                class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 text-sm">Pcs</span>
                                        </div>
                                        @error('stok')
                                            <p class="mt-1 text-xs text-rose-500 font-medium italic">* {{ $message }}
                                            </p>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <div>
                                                ...
                                                @error('kategori')
                                                    <p class="mt-1 text-xs text-rose-500 font-medium italic">*
                                                        {{ $message }}
                                                    </p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="md:col-span-2">
                                        <label for="deskripsi"
                                            class="block text-sm font-semibold text-DarkChocolate mb-2">Sinopsis /
                        ...
                        <div
                            class="mt-12 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-end gap-3">
                            <a href="{{ url()->previous() }}"
