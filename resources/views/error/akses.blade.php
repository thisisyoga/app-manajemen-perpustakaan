...
<body class="min-h-screen flex items-center justify-center overflow-hidden relative">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex justify-around items-center opacity-30 pointer-events-none">
        <div class="w-[500px] h-[500px] bg-sky-600/30 rounded-full filter blur-[120px] animate-morph"></div>
        <div class="w-[500px] h-[500px] bg-blue-700/20 rounded-full filter blur-[120px] animate-morph" style="animation-delay: -5s;"></div>
    </div>

    <div class="relative z-10 w-full max-w-lg px-6 flex flex-col items-center justify-center">
        <div class="glass-container w-full rounded-[3rem] p-12 text-center sky-neon-glow transform transition-all duration-700 hover:scale-[1.01]">
            ...
            <div class="relative mb-8 inline-block">
                ...
                <div class="relative bg-slate-900 border border-sky-500/30 p-7 rounded-[2.5rem] shadow-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-sky-400 animate-floating" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="space-y-4">
                <a href="{{ url('/') }}" class="group relative flex items-center justify-center w-full py-4 bg-sky-600 text-white rounded-2xl font-bold transition-all duration-300 hover:bg-sky-500 hover:shadow-[0_0_30px_rgba(14,165,233,0.4)] active:scale-[0.97]">
                ...
                <button onclick="window.history.back()" class="w-full py-2 text-slate-500 hover:text-sky-400 transition-colors text-[10px] font-bold tracking-[0.4em]">
