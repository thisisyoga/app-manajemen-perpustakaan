    ...
    Route::get('/akses-ditolak', function () {
        ...
        Route::middleware('role:user')->group(function () {
            Route::get('/profile-user', [ProfileController::class, 'profilUser'])->name('user.profile');
            Route::patch('/profile-user', [ProfileController::class, 'updateUser'])->name('user.profile.update');
    ...
    Route::middleware(['role:admin|petugas'])->group(function () {
        ...
        Route::patch('/profile/update', [ProfileController::class, 'updateAdmin'])->name('profile.update.admin');
